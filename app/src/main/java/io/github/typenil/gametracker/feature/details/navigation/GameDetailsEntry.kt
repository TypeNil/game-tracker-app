 ...
 * No launchSingleTop: it deduplicates by route template (GameDetailsKey),
 * not by gameId, so similar-game navigation would silently drop the push.
 * Stacking distinct game ids is the intended behavior.
 */
