...
- **Рекомендации на устройстве**: детерминированный эвристический скоринг по жанрам, темам и платформам на основе библиотечных сигналов пользователя с формированием объяснений ранжирования.
...
- **WorkManager**: периодическая проверка дат релизов отслеживаемых игр с учетом сетевых ограничений, дедупликацией уведомлений и типизированными deep links (`gametracker://game/{id}`).
